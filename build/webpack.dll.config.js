...
delDir(path.resolve(src_path,'webStatic/bundles'))
...
module.exports = {
    ...
    output: {
        ...
        path: path.resolve(src_path,'webStatic/bundles/'),
    ...
    plugins: [
        new webpack.DllPlugin({
            ...
            path:   path.resolve(src_path,'webStatic/bundles')+ '/[name].manifest.json',
